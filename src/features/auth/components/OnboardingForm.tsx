...
export function OnboardingForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-md px-6 py-10">
      ...
      <div className="mb-5 flex rounded-2xl bg-black/[0.04] p-1">
        <button
          type="button"
        ...
        <div className="space-y-3">
          <label className="block text-sm font-medium">
            ...
            <input
              ...
              className="mt-1 w-full rounded-2xl border border-black/10 bg-surface px-4 py-3"
            />
          </label>
          <label className="block text-sm font-medium">
            사업자등록번호
            <input
              ...
              className="mt-1 w-full rounded-2xl border border-black/10 bg-surface px-4 py-3 tracking-wider"
            />
          </label>
          <button
            type="button"
        ...
        <div className="space-y-3">
          <label className="block text-sm font-medium">
            ...
            <input
              ...
              className="mt-1 w-full rounded-2xl border border-black/10 bg-surface px-4 py-3 tracking-widest"
            />
          </label>
          <button
            type="button"
