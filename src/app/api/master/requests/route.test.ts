...
describe("GET /api/master/requests — 마스터 수정요청 조회 (FR-2)", () => {
  ...
  // AC-5/AC-6: 마스터는 전체 크루 요청을 200·최신순·크루명 매핑으로 받는다.
  it("마스터는 전체 크루의 요청을 200·크루명 포함으로 반환한다", async () => {
    addRequest({
      date: "2026-05-04",
      reason: "정정A",
  ...
  // AC-8/AC-R3: 크루는 403 + 목록 미노출.
  it("크루 역할은 403 을 반환한다", async () => {
